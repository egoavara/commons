src = """AliceBlue 	#F0F8FF	 	Shades	Mix
...
def hextorgb(hexsrc: str) -> (int, int, int):
    return int(hexsrc[0:2], 16), int(hexsrc[2:4], 16), int(hexsrc[4:6], 16)
...
with open("html.txt", "w", encoding='utf8') as f:
    for line in src.splitlines():
        temp = line.split("#")
        name = temp[0].strip()
        value = hextorgb(temp[1].split(" ")[0].strip())
